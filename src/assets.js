...
export default {
  ...
  foxr_tex: {
    url: "foxr.png",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  ...
  doorfx_tex: {
    url: "doorfx.basis",
    options: { wrapT: THREE.RepeatWrapping, wrapS: THREE.RepeatWrapping },
  },
  sky_tex: {
    url: "sky.png",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  ...
  stereopanoL: {
    url: "stereopanoL.basis",
    options: { encoding: THREE.sRGBEncoding },
  },
  stereopanoR: {
    url: "stereopanoR.basis",
    options: { encoding: THREE.sRGBEncoding },
  },
  pano1small: {
    url: "stereopano_small.basis",
    options: { encoding: THREE.sRGBEncoding },
  },

  pano2: {
    url: "tigerturtle.basis",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  pano3: {
    url: "lakebyllesby.basis",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  pano4: {
    url: "haldezollern.basis",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  pano5: {
    url: "zapporthorn.basis",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  pano6: {
    url: "thuringen.basis",
  ...
  pano2small: {
    url: "tigerturtle_small.basis",
    options: { encoding: THREE.sRGBEncoding },
  },
  pano3small: {
    url: "lakebyllesby_small.basis",
    options: { encoding: THREE.sRGBEncoding },
  },
  pano4small: {
    url: "haldezollern_small.basis",
    options: { encoding: THREE.sRGBEncoding },
  },
  pano5small: {
    url: "zapporthorn_small.basis",
    options: { encoding: THREE.sRGBEncoding },
  },
  pano6small: {
    url: "thuringen_small.basis",
    options: { encoding: THREE.sRGBEncoding },
  },
  ...
  vertigo_door_lm_tex: {
    url: "vertigo_door_lm.jpg",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  vertigo_lm_tex: {
    url: "vertigo_lm.basis",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  checkboard_tex: {
    url: "checkboard.basis",
    options: {
  ...
  // paintings
  painting_seurat_tex: {
    url: "paintings/seurat.basis",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  painting_sorolla_tex: {
    url: "paintings/sorolla.basis",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  painting_bosch_tex: {
    url: "paintings/bosch.basis",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  painting_degas_tex: {
    url: "paintings/degas.basis",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
  painting_rembrandt_tex: {
    url: "paintings/rembrandt.basis",
    options: { encoding: THREE.sRGBEncoding, flipY: false },
  },
